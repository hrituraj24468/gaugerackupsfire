...
namespace iotracks.iotrack
{
    public partial class UserControl1 : UserControl
    {
        ...
        private bool isCircleVisible = true;
        private int _fire;// State for the circle's visibility
        ...
        public UserControl1()
        {
            ...
            this.Size = new Size(245, 400);  // Fixed size of UserControl1
            ...
            // Set the SizeMode to ensure the image scales
        }
        protected override void OnSizeChanged(EventArgs e)
        {
            base.OnSizeChanged(e);

            // Reset the size back to the fixed size if the user tries to resize
            this.Size = new Size(242, 420);  // Fixed size of UserControl1
        }
        ...
        private void UpdateLabel()
        {
            ...
            if (temperatureData != null)
            {
                ...
                if (_Temperature < 30)
                {
                    temperatureData.ForeColor = ColorTranslator.FromHtml("#99FF00"); ;
                }
        ...
        private void PictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            fireData.Location = new Point(pictureBox.Width / 2 - humidityData.Width / 2 -20, pictureBox.Height - 200);
        ...
        private void DrawBlinkingCirclewld(Graphics g)
        {
            ...
            {
                int circleDiameter = 8;
                int circleX = pictureBox.Width / 2 - circleDiameter / 2 + 23;
                int circleY = pictureBox.Height / 2 - circleDiameter / 2 - 5;
                Color circleColor;
                if (_Humidity < 30)
                {
        ...
        internal object SetValues(int temperature, int humidity)
        {
